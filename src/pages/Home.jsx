...
const Home = () => {
    return (
        <div className="home-page">
            <GlobalSEO
                title="Professional Drycleaners & Laundry Hub in Lang'ata, Nairobi | Doveleaf"
                description="Professional garment care at your convenience. Free pickup and delivery in Lang'ata, Nairobi. Premium care for wedding gowns, leather, and delicate fabrics. Express service at no extra cost."
                path="/"
            />
            {/* Hero Section */}
            <section style={{
